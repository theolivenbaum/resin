...
ResinDB is an embedded disk-based database and search engine with concurrent read/write. You may utilize it's indexing and querying properties through an API, a query language and a command-line interface.  
