...
Even though this is about Resin to Google this article is very much about Lucene, so much so that querying it's enourmous index with the term "body:lucene" will render this document in it's results. One could argue that since Lucene is being brought up and very early to that this document certainly is about Lucene. I buy that but would still like to say, this will be mostly about how I built my own indexer-searcher thing that can __index 1M english wikipedia articles in approximately 3 minutes and then respond to multi-criteria term-based or prefix queries towards that index in less than a tenth of a millisecond__. That's on my 3 year old i5 laptop. It's really thin. An orange Lenovo Yoga 2 Pro. Just sayin'.
