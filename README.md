...
__Write__ data flow: documents are persisted, then turned into vectors that turn into nodes in a graph that turn into a bitmap that is persisted on disk as a segment in a column file.
